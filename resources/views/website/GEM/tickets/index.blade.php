        ...
        <div class="container">
            <div class="inner-container">
                ...
                <div class="tab-content">
                    ...
                    <!-- Payment -->
                    <x-forms.tickets-pay-form :redirectTo="route('gem.tickets.index')" :user="$user" :selectedTickets="$selectedTickets" />
...
@section('js')
    @include('components.scripts.tickets-script', ['ticketsIndexRoute' => route('gem.tickets.index')])
@endsection
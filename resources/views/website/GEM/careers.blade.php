  ...
  <section class="contact-one">
    <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="contact-one__main">
              <div class="contact-one__image">
                <img src="{{ asset('assets/GEM/images/resources/contact-1-1.jpeg') }}" class="img-fluid" alt="GEM Contact Us" />
              </div>
          ...
          <div class="col-md-6">
            <form action="{{route('gem.careers.store')}}" method="POST" enctype="multipart/form-data" class="contact-one__form">
                @csrf
                <div class="row">
                    <div class="col-md-6">

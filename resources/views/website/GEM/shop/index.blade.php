...
@section('content')
    ...
    <section class="inner-banner" style="background-image: url('{{ asset('assets/GEM/images/Background/shop-bg.png') }}'">
        <div class="container">
    ...
    <div class="product-sorting">
        <div class="container">
            <x-forms.shop-sorting-form :route="route('gem.shop.index')" :products="$products"/>
        </div>
    </div>

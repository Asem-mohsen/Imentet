                ...
                <div class="col-lg-6">
                    <div class="product-details__content">
                        <form method="POST" action="{{ route('imentet.cart.add') }}" id="add-to-cart-form">
                            ...
                            <p class="product-details__price">{{$product->final_price . ' EGP'}}</p>
                                                    ...
                                                    <form action="" method="post" class="mb-5">
                                                        <div class="product-details__review-single">
                                                            <div class="product-details__review-left">
                                                                <img loading="lazy" src="{{$review->user->getFirstMediaUrl('user_profile_image') ?: asset('assets/GEM/images/team/avatar.png')}}" width="70px" height="70px" alt="{{$review->user->fullName}}" />
                                                            </div>
                        ...
                        <div class="product-one__single">
                            ...
                            <div class="product-one__content">
                                ...
                                <div class="product-one__content-right">
                                    @if($product->stock_quantity > 0)
                                        <button data-toggle="tooltip" data-placement="top" title="Add to Cart" class="product-one__cart-btn add-to-cart" data-id="{{ $product->id }}"><i class="egypt-icon-supermarket"></i></button>
                                    @else
                                        Out of Stock
                                    @endif
                                </div>

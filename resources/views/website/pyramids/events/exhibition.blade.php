                  ...
                  <div class="exhibhition-one__single wow fadeInUp" data-wow-duration="1500ms">
                    <div class="exhibhition-one__image">
                      <div class="exhibhition-one__image-inner" style='max-height:210px'>
                        ...
                        <a href="{{route('pyramids.events.show' , $event->id)}}" class="exhibhition-one__image-link">
                          <i class="egypt-icon-arrow-1"></i>
                        </a>
                      </div>
                    </div>
                    <div class="exhibhition-one__content">
                      <a href="{{ route('pyramids.events.index', ['event_category' => 'exhibitions']) }}" class="exhibhition-one__category">{{$event->category->name}}</a>
                      <h3 class="exhibhition-one__title">
                        <a href="{{route('pyramids.events.show' , $event->id)}}">
                          {{$event->title}}
                        </a>
                      </h3>
                      <div class="exhibhition-one__bottom">
                        ...
                        <div class="exhibhition-one__bottom-right">
                          <a href="{{route('pyramids.events.show' , $event->id)}}" class="thm-btn exhibhition-one__btn">Read More</a>
                        </div>
                      </div>
                    </div>
                  </div>

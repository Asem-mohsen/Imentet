            ...
            <div class="inner-container">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active animated fadeInUp" id="tickets">
                        <form method='POST' action="{{ route('pyramids.tickets.storeSelections') }}" id="ticketForm">
                            @csrf
                            <div class="top-tabs">
                    ...
                    @if($user)
                        <div class="tab-pane animated fadeInUp" id="payment">
                            <form method="POST" action="{{route('pyramids.payments.tickets')}}" class="donation-form__form">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-8">
                                        ...
                                        <div class="table-outer table-responsive">
                                            ...
                                            <div class="cart-total custom-cart-total">
                                                ...
                                                @else
                                                    <a href="{{route('pyramids.tickets.index')}}" class="thm-btn cart-update__btn cart-update__btn-three">
                                                        Select Tickets
                                                    </a>
                                                @endif
                                            </div>
...
@section('js')
    @include('website.pyramids.tickets.scripts.tickets-script')
@endsection
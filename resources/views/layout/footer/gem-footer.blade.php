<footer class="site-footer">
    <div class="container">
      <a class="site-footer__logo" href="{{ route('gem.home') }}"
        ><img loading="lazy" src="{{ asset('assets/GEM/images/resources/footer-logo-imentet-gem.png') }}" alt=""
      /></a>
      ...
      <p class="site-footer__copy">
        Copyrights &copy; {{ date('Y') }}<a href="{{ url()->current() }}"> Egypt</a>, All Rights Reserved.
      </p>
    </div>
</footer>
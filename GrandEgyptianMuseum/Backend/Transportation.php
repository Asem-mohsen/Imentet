    ...
    if($AdminRole != 4 && $AdminRole != 3 ){
        ...
        if($do == "Manage"){ 
                ...
                $End = $_POST['End'];
                    ...
                    if(empty($FormErrors)){
                        ...
                        $Update = mysqli_query($con, $UpdateQuery);
                                ...
                                $TheMsg = "<div class='alert alert-success'> Transportation Time Updated Successfully </div>";
                ...
                $End = $_POST['End'];
                    ...
                    if(empty($FormErrors)){
                        ...
                        $Insert = mysqli_query($con, $InsertQuery);
                                ...
                                echo "<div class='container'>";
                                $TheMsg = "<div class='alert alert-success'> Transportation Time Added Successfully </div>";
                                RedirectIndex($TheMsg, "Back");
                                echo "</div>";
                    }else{
                        foreach($FormErrors as $error){
            ...
            if ($Check > 0) {
                ...
                echo "<div class='container'>";
                $TheMsg = "<div class='alert alert-success'>"  . "Transportation Deleted Successfully" . '</div>';
                RedirectIndex($TheMsg, "Back");
                echo "</div>";
            } else {
                echo "<div class='container'>";
                $TheMsg = "<div class='alert alert-danger'>" . "The Transportation Does Not Exist" . "</div>";

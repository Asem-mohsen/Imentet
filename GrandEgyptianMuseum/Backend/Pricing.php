        ...
        if($do == "Manage"){
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {      
                ...
                if(empty($FormErrors)){
                    ...
                    $TheMsg = "<div class='alert alert-success'>"  . "Price Added Successfully" . '</div>';
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') { 
                ...
                if (empty($FormErrors)) {
                    ...
                    echo "<div class='container'>";
                    $TheMsg = "<div class='alert alert-success'> Price Updated Successfully </div>";
                    RedirectIndex($TheMsg, "Back");
                    echo "</div>";
                    ...
                    $RoleID = isset($_GET['RoleID']) && is_numeric($_GET['RoleID']) ? intval($_GET['RoleID']) : 0;
                            ...
                            if ($Check > 0) {
                                ...
                                echo "<div class='container'>";
                                $TheMsg = "<div class='alert alert-danger'>" . "The Pricing Category Does Not Exist" . "</div>";

    ...
    <?php include "./NavUserPyramids.php"; ?>
                            ...
                            <div class="collection-details__sidebar-single">
                                ...
                                <ul class="collection-details__sidebar-list list-unstyled">
                                    <li>
                                        ...
                                        <span class="collection-details__sidebar-list__value">Ancient Egyptian</span>
                                    </li>
                                    <li>
                                        <span class="collection-details__sidebar-list__name">
                                            Year
                                        ...
                                        <span class="collection-details__sidebar-list__value">2500 BC</span>
                                    </li>
                                    <li>
                                        <span class="collection-details__sidebar-list__name">
                                            Style
        ...
        <div class="collection-details__paginations">
            <div class="container">
                ...
                <?php }else{ ?>
                    <div class="col-sm-3 text-center">
                        <a href="http://localhost/imentet-1/GrandEgyptianMuseum/Backend/Project/Collections.php"> Collections Page <span>-</span></a>
                    </div>
                <?php } ?> 
                
                <div class="col-sm-6 text-center">
                    <a href="http://localhost/imentet-1/GrandEgyptianMuseum/Backend/Project/Collections.php"><i class="egypt-icon-menu"></i></a>
                </div>
                <!-- NEXT  -->
                <?php
                            ...
                            <div class="collection-two__single">
                                ...
                                <div class="collection-two__content">
                                    <p class="collection-two__category">
                                        <a href="http://localhost/imentet-1/GrandEgyptianMuseum/Backend/Project/Antiquities.php?CatID=<?php echo $SimilarColl['CatID'] ?>">
                                            <?php echo $SimilarColl['CollectionCategory'] ?>
                                        </a>
                                    </p>
                                    
                                    <h3 class="collection-two__title"><a href="http://localhost/imentet-1/Pyramids/pyramids/CollectionDetails.php?CollectionID=<?php echo $SimilarColl['ID'] ?>"><?php echo $SimilarColl['Collection'] ?></a></h3>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
